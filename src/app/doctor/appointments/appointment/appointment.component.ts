...
export class AppointmentComponent implements OnInit, OnDestroy{
  ...
  ngOnInit(): void {
    ...
    this.doctorService.getDoctorByEmail(EmailUser).subscribe( doctor => this.medico = doctor.medico)
  ...
  generarReceta(){
    ...
    const hora = this.patientDetails.hora_cita;
	        ...
	        table:{
                ...
                body: [
                    [
                        ...
                        {
                            text: `${ this.medico.nombre + ' ' + this.medico.apellidos}
                            Especialidad: ${this.medico.especialidad}
                            Cedula: ${ this.medico.cedula == null ? '' : this.medico.cedula}
                            Permiso SS: ${ this.medico.permiso_secre_salud == null ? '' : this.medico.permiso_secre_salud}
	        ...
	        table:{
                ...
                body: [
                    [
                        ...
                        {
                            text: `Torre Medica 905

                            Presa Adolfo López Mateos 905, Las Quintas, 80060 Culiacán Rosales, Sin.`
                        },
                        {
                          // image: 'data:image/jpeg;base64,',
                          // width: 100,
